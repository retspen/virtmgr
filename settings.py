# Django settings for virtmgr project.
import os
import django
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '1qAz45G!c',         # Not used with sqlite3.
...
SECRET_KEY = '(__oq5v44crf^r__^-^xwc)97o)j)fyg5u=_q5)o*5^4r$1r^v'
